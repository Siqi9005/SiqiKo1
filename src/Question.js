...
class Question extends Component {
    ...
    componentDidMount(){
        this.socket = mySocket("http://localhost:10010/");
            ...
            if(this.state.host ===true){
                ...
                comp = (
                    <div>
                        ...
                        <button  id="click" onClick={this.handleAnswer.bind(this, "1")}>{this.state.qobj.o1}</button>
                        <button  id="click1" onClick={this.handleAnswer.bind(this, "2")}>{this.state.qobj.o2}</button>
